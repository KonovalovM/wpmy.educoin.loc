...
<h4 class="page-title"><?=edc__( 'Курсы' )?></h4>
<br>
                ...
                <tbody>
                    ...
                    <?php } ?>
                      ...
                      <tr>
                          ...
                          <td class="">
                            ...
                            <!-- Get list of roles -->
                            <select disabled name="role" class="form-control form-control-sm">
                                <?php 
                    ...
                    <tr>
                        ...
                        <td class="">
                          ...
                          <select disabled name="support_id" class="form-control form-control-sm">
                    ...
                    <tr>
                        ...
                        <td class="">
                          ...
                          <select disabled name="course_to_user_status_id" class="form-control form-control-sm mb-2">
                              <?php 
                          ...
                          <input disabled type="text" class="form-control form-control-sm" value="<?=$user_course['disabling_reason']?>" placeholder="<?=edc__( 'Причина деактивации...' )?>" name="disabling_reason" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-p-20"><?=edc__( 'Дата начала (открытия доступа) курса' )?></th>
                        <td class="">
                          <input disabled type="text" class="form-control form-control-sm" value="<?=$course_date_start?>" placeholder="<?=edc__( 'Дата начала курса...' )?>" name="course_date_start" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-p-20"><?=edc__( 'Дата окончания курса' )?></th>
                        <td class="">
                          <input disabled type="text" class="form-control form-control-sm" value="<?=$course_date_end?>" placeholder="<?=edc__( 'Дата окончания курса...' )?>" name="course_date_end" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="">
                          ...
                          <div class="form-check">
                            <input disabled <?=$checked?> type="checkbox" class="form-check-input" name="is_homeworks_disabled" value="1">
                          </div>
                    ...
                    <tr>
                        ...
                        <td class="">
                          ...
                          ?>
                          <div class="form-check">
                            <input disabled <?=$checked?> type="checkbox" class="form-check-input" name="is_demo_mode" value="1">
                          </div>
                      ...
                      <tr>
                          ...
                          <td class="">
                            ...
                            ?>
                            <div class="form-check">
                              <input disabled <?=$checked?> type="checkbox" class="form-check-input" name="is_low_priority" value="1">
                            </div>
                      ...
                      <tr>
                          ...
                          <td class="">
                                <textarea disabled class="form-control advanced" rows="5" name="cert_comments"><?=html_entity_decode( $user_course_cert['comments'] )?></textarea>
                          </td>
                      </tr>
                </tbody>   
            </table>
